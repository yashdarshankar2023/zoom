...
const main__participants__window = document.getElementById("main__participants_window");
...
const showWhite = () => {
    ...
    window.location.href = "https://witeboard.com/ca8be740-8da5-11ed-9c3c-878ae84cb2e9";
    // window.location.href  = "static/whiteboard.html";
}
const showParticipants = () =>{
    if (participants.hidden == false) {
        participants.hidden = true;
    } else {
